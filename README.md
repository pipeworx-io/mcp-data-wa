...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/data_wa_datasets \
  -H 'Content-Type: application/json' \
  -d '{"query":"crime"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/data_wa_datasets`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
